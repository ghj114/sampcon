...
func createCgroupConfig(context *cli.Context, spec *specs.Spec) (*Cgroup, error) {
...
func createDevices(spec *specs.Spec, config *Config) error {
...
func Specconv(context *cli.Context, spec *specs.Spec) (*Config, error) {
	dir, _ := os.Getwd()
	...
	c, _ := createCgroupConfig(context, spec)
	config.Cgroups = c
...
func createmount(path string, m *specs.Mount) *Mount {
