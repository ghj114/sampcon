...
func (s *CpuGroup) ApplyDir(path string, cgroup *config.Cgroup, pid int) error {
...
func (s *CpuGroup) SetRtSched(path string, cgroup *config.Cgroup) error {
...
func (s *CpuGroup) Set(path string, cgroup *config.Cgroup) error {
